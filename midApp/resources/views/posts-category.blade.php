        ...
        <li class="nav-item">
          ...
          <li class="nav-item dropdown ">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  @foreach(App\Models\Category::all() as $categ)
                  <li><a class="dropdown-item" href="/categories/{{$categ->id}}">{{$categ->category}}</a></li>
                  @endforeach
              </ul>
          </li>
          <li class="nav-item">
...
<div class="row">
  <div class="col-md-8 mx-auto">
    <h3 class="pt-3 text-center text-light">{{$category->category}} Posts</h3>
    <hr>
